...
if(!/vingt heures réparties sur trois semaines/.test(historyFrMd)||!/twenty hours spread over three weeks/.test(historyEnMd)||!/99 843 tokens/.test(historyFrMd)||!/99,843 tokens/.test(historyEnMd))throw new Error("The bilingual histories do not document the available time and token measurements.");
